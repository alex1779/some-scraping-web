...
def start():
    ...
    if MyClass.FirstTime == True:
        print('Bienvenido a mi Programa!')
        print('Una carpeta llamada "Output" fué creada en el directorio actual para almacenar los resultados.')
...
def main():
    start()
    for section in MyClass.sections2:
        try:
